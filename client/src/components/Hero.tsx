...
export default function Hero() {
    ...
    const mainImageUrl = 'https://images.unsplash.com/photo-1690191848328-7410cdf9962b?q=80&w=1576&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
